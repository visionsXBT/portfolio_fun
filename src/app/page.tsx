      ...
      <section className="px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="mx-auto max-w-4xl lg:max-w-5xl xl:max-w-6xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <a href="/builder" className="rounded-lg gradient-button px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 text-sm sm:text-base md:text-lg font-medium text-white">
              Open portfolio builder
            </a>
            <a href="/leaderboard" className="rounded-lg border border-white/20 bg-white/5 hover:bg-white/10 px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 text-sm sm:text-base md:text-lg font-medium text-white transition-colors">
              🏆 View Leaderboard
            </a>
          </div>
        </div>
